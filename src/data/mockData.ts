...
export const categories = [
  ...
  { id: "video", label: "视频", icon: "🎬", count: 54 },
...
export const products: Product[] = [
  ...
  },
  {
    ...
    description: "Kimi是由月之暗面(Moonshot AI)推出的AI助手，支持20万字超长上下文，在中文理解和生成方面表现卓越。适合长文档分析、学术研究、内容创作等场景。",
    logo: "",
    tags: ["AI助手", "长文本", "中文"],
  ...
  },
  {
    ...
    description: "Devin是Cognition推出的全球首个AI软件工程师。它可以自主规划和执行复杂的工程任务，包括学习新技术、调试代码、部署项目等。",
    logo: "",
    tags: ["AI工程师", "自动化", "编程"],
    category: "agents",
    upvotes: 1823,
  ...
  },
  {
    ...
    description: "Sora是OpenAI推出的文生视频AI模型，能够根据文字描述生成长达60秒的高质量视频。它理解物理世界的运动和光影，生成的视频细节丰富且逼真。",
    logo: "",
    tags: ["文生视频", "OpenAI", "内容创作"],
    category: "video",
    upvotes: 1647,
    views: 51200,
    comments: 178,
